...
# plot 4
par(mfrow = c(2, 2))
plot(data_project$DateTime, data_project$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
plot(data_project$DateTime, data_project$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(data_project$DateTime, data_project$Global_reactive_power, type = "l", ylab = "Global_reactive Power", xlab = "datetime")
